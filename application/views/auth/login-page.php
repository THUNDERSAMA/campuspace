...
<head>
    <title>Login to campuSpace</title>
    <meta charset="utf-8">
    ...
    .bg-glass {
        background: linear-gradient(rgba(57, 30, 114, 0.549), transparent 80%);
    ...
    .form button {
        margin-top: 10px;
        border-color: #ffd8e4a4;
        border-width: 2px;
    }

    .form button:hover {
        background-color: #efb8c848;
    }
...
<body onload="typeWriter()">
    <div class="planet-cont">
        <img src="<?php echo base_url("images/rotating-planet.png")?>" class="planet corner">
    </div>
        ...
        <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
            <div class="row gx-lg-5 mb-5 justify-content-between">
                ...
                var typing = new Typed('#typing', {
                    strings: ["Be the 'PITCHERS'",
                        "'The best way to predict the future is to create it.' -Peter Drucker",
                        "Campuspace is designed to empower the next generation of entrepreneurs.",
                        "Say goodbye!&#128075; to generic networking platforms.",
                        "Join us! to CONNECT, COLLABORATE and THRIVE in the world of startups."
                    ],
                    typeSpeed: 50,
                    backSpeed: 0,
                    fadeOut: true,
                    ...
                    <div class="card bg-glass">
                        ...
                        <form class="needs-validation" novalidate>
                            <ul class="nav nav-pills mt-4 mb-2" id="pills-tab" role="tablist">
                                <li class="nav-item text-center ps-3">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="form mx-4 py-5">
                                        <div class="input-group has-validation">
                                            <input type="email" name="" id="lemail" class="form-control"
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="password" name="" id="lpass" class="form-control"
                                                placeholder="Password" required>
                                            <div class="invalid-feedback mb-2">
                                                Please enter a password.
                                            </div>
                                        </div>
                                        <button class="animate1 btn text-light btn-block col-12" id="login">Log
                                            In</button>

                                        <div class="mt-3 px-2">
                                            <a href="<?php echo base_url("index.php/LoginController/frp"); ?>"
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                    ...
                                    <div class="form mx-4 py-5">
                                        <div class="input-group has-validation">
                                            <input type="email" name="" class="form-control" id="semail"
                                                placeholder="E-mail address" required>
                                            <div class="invalid-feedback mb-3">
                                                Please enter your E-mail address.
                                            </div>
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="password" name="" autocomplete="off" id="spass"
                                                class="form-control" placeholder="Password" for="newPassword" required>
                                            <div class="invalid-feedback mb-3">
                                                Please enter a password.
                                            </div>
                                        </div>
                                        <div class="input-group has-validation">
                                            <input type="password" id="srpass" autocomplete="off" name=""
                                                class="form-control" placeholder="Confirm Password"
                                                for="confirmPassword" required>
                                            <div class="invalid-feedback mb-2">
                                        ...
                                        <div class="form-check mx-2 mb-2">
                                            ...
                                            <label class="form-check-label" for="invalidCheck">
                                                <a href="#" style="color:#fff;">terms and conidtions</a>
                                            </label>
                                            <div class=" invalid-feedback mt-2">
                                                You must agree before submitting.
                                            </div>
                                        </div>
                                        <button class="animate1 btn text-light btn-block col-12" id="signup">Sign
                                            Up</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            .then((result) => {
                                if (result.isConfirmed) {
                                    window.location.href =
                                        '<?php echo base_url("index.php/Logincontroller/logins") ?>';
                                }
                            })
