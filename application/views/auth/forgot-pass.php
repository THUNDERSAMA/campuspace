...
<head>
    ...
    <style>
        ...
        .bg-glass {
            background: linear-gradient(#391e728c, transparent 90%);
            ...
            <div class="row gx-lg-5 mb-5 justify-content-between">
                ...
                <script>
                    ...
                    var typing = new Typed('#typing', {
                        strings: ["So you have forgotten your password ?", "No worries, you can change it anytime.", "Provide your registered email-id."],
                        typeSpeed: 50,
                        backSpeed: 0,
                        fadeOut: true,
                        loop: true
                ...
                <div
                    ...
                    <!-- <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item text-center">
                            <div class="nav-link active btrl" id="pills-home-tab">Forgot Password ?</div>
                        </li>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="form px-4 py-4">
                                        ...
                                        <button class="animate1 btn text-light btn-block col-12"
                                            href="new-pass.html">Change
                                            Password</button>
