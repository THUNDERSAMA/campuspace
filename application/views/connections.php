...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("css/cn/style-comments.css")?>">
    <link rel="stylesheet" href="<?php echo base_url("css/style-modals.css")?>">
    <link rel="stylesheet" href="<?php echo base_url("css/cn/style.css")?>">
...
$datas = json_decode(json_encode($datas), true); foreach ($datas as $choice) { ?>
            <div class="dark-container first">

                <a class="dark-pfp" href="http://localhost/anonimly/index.php/ProfileController/profile?id=<?php echo $choice['CID']; ?>">
                    <img src="<?php echo $choice['IMAGES']; ?>"
                        alt="">
                </a>
                <span><?php echo $choice['SIID']; ?></span>
                <ul class="connect-opt">
                    <li class="pvideo">
                        <a href="<?php echo base_url("index.php/MainController/videocall?id=".uniqid()) ?>">
                            <img src="<?php echo base_url("svg-sources/videocam_white_24dp.svg")?>" alt="ico" />
                        </a>
                    </li>

                    <li class="pchat">
                        <?php $vccall = $this->session->userdata('auth')['SIID']." invited you to join a video conference at: ".base_url("index.php/MainController/videocall?id=".uniqid());?>
                        <a href="mailto:<?php echo (base64_decode($choice['CID'])); ?>?subject=VC Invite from CampuSpace&body=<?php echo $vccall;?>">
                            <img src="<?php echo base_url("svg-sources/email_white_24dp.svg")?>" alt="ico" />
                        </a>
                    </li>

                    <li class="pblock">
                        <a href="javascript:block('<?php echo $choice['CID']; ?>');">
                            <img src="<?php echo base_url("svg-sources/block_white_24dp.svg")?>" alt="ico" />
                        </a>
                    </li>
                </ul>
            </div>
...
$.ajax({
      type: "POST",
      url: "<?php echo base_url('index.php/ProfileController/ablock'); ?>",
      data: cdata,
      success: function(response) {
        console.log(response);
        if (response=="ok") {
            Swal.fire(
  "Really it's not your taste",
  'User Blocked!',
  'success'
);
        } else {
